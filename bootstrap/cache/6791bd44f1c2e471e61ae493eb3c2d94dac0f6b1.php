          ...
          <div> 
               <div class="menu-user"><i class="fa fa-user main-user-fa"></i></div>
                <div class="menu-user-options">  
                    ...
                    <h3 class='user-menu-option text-center'>Hello <?php echo e(user()->username); ?></h3>
    ...
    <div class='mobile-menu'>
        <div class='search-mobile'>
            <form action="/search-result" method="GET" class="search-form-mobile">
              <input type="search" value="<?php echo e(\App\Classes\Request::old('get', 'search')); ?>" name="search" placeholder="Search" class='search-edit-mobile'> 
...
<?php /**PATH C:\Users\sada_\Downloads\xampp program\htdocs\ecommerce\resources\views/includes/nav.blade.php ENDPATH**/ ?>