...
//admin routes (the @show method was to display the admin dashboard)
...
//product management (the @show method was to display the product category)
...
//products
$router->map('GET', '/admin/product/[i:id]/selected', 'App\Controllers\Admin\ProductController@getSubcategories', 'selected_category');
...
$router->map('GET', '/admin/users/orders', 'App\Controllers\Admin\OrderController@showOrders', 'show_orders');
